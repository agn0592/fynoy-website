    ...
    <section className="section">
      <div className="wrap legal-wrap">
        ...
        <div className="legal-block">
          ...
          <p className="muted">Last updated: May 2025</p>
          <p>
          ...
          <p>
            We collect only the data you voluntarily provide — for example, your name and contact details
            when you reach out via WhatsApp or email. We do not run advertising networks or sell personal
            data to third parties.
          </p>
          <h3>How we use it</h3>
          <p>
            Data you share is used solely to respond to your enquiry, add you to the research group (if
            requested), or manage our collaboration. We retain data only as long as necessary.
          </p>
        ...
        <div className="legal-block">
          ...
          <p>
            All content on this site — including stock research, pitch summaries, and performance figures —
          ...
          <p>
            ...
            regulator. The research group and collaboration programme are private, non-commercial activities.
            We do not manage third-party capital.
          </p>
          ...
          <p>
            ...
            from reliance on any information published on this site or shared within the research group.
          </p>
        </div>
        ...
        <div className="legal-block">
          ...
          <p>
            ...
            strictly necessary technical cookies required for the site to function (e.g., security tokens).
            No cookie consent banner is shown because no non-essential cookies are placed.
          </p>
          <p>
        ...
        <div className="legal-block">
          ...
          <p>
            The views expressed by Fynoy Capital represent the personal opinions of its principals and
            should not be construed as professional investment advice. You should conduct your own research
            and, if appropriate, seek advice from a licensed financial adviser before making any investment
            decision.
          </p>
          <p>
            Fynoy Capital may hold positions in securities discussed on this site. This constitutes a
            conflict of interest that readers should be aware of.
          </p>
