...
export default function PortfolioSummary({
  unrealizedPnlPct, realizedPnlYtdPct, openPositionsCount,
  twrPct, vwcePct, alphaPct, inceptionDate,
      ...
      <div className="dash-stats-stack" style={{ marginTop: 12 }}>
        <div className="dash-stat-cell">
          <div className="dash-stat-label">
            YTD Unrealized
            <InfoTooltip term="ytd-unrealized" />
          </div>
        ...
        <div className="dash-stat-cell">
          <div className="dash-stat-label">
            Total Return
            <span style={{ fontWeight: 400, opacity: 0.5, fontSize: '0.8em', marginLeft: 4 }}>TWR</span>
        ...
        <div className="dash-stat-cell">
          <div className="dash-stat-label">
            vs VWCE
            <span style={{ fontWeight: 400, opacity: 0.5, fontSize: '0.8em', marginLeft: 4 }}>α</span>
        ...
        <div className="dash-stat-cell full-width">
          <div className="dash-stat-label">
            Open Positions
            <InfoTooltip term="open-positions" />
          </div>
