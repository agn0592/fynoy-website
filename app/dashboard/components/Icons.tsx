// Centralised SVG icon set for the dashboard shell + pages
// All icons inherit currentColor / stroke
...
export const IconChevronDown = (p: SVGProps<SVGSVGElement>) => (
  <svg {...base(p)} width={12} height={12}><polyline points="6 9 12 15 18 9" /></svg>
)
...
export const IconDelete = (p: SVGProps<SVGSVGElement>) => (
  <svg {...base(p)}><polyline points="3 6 5 6 21 6" /><path d="M19 6l-2 14a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2L5 6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /></svg>
)
